...
class LOAD_CIFAR100():
    ''' 
    Classe CIFAR 100 LOAD and add noise
    '''

    def __init__(self, diretorio='cifar-100-python', 
        ...
        print('Carregando CIFAR-100 da pasta: ',self.diretorio)
        ...
        self.test_labels=to_categorical(self.test_labels,num_classes=self.nb_classes)
        ...
        self.train_noisy_labels=to_categorical(self.train_noisy_labels,num_classes=self.nb_classes)
        self.train_labels=to_categorical(self.train_labels,num_classes=self.nb_classes)
